...
<body class="bg-gray-50">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-16">
                <div class="flex items-center space-x-2">
                    ...
                    <span class="text-2xl font-bold gradient-text">Passtik</span>
                </div>
                <div class="hidden md:flex items-center space-x-4">
                    @auth
                        <a href="/routers" class="text-gray-700 hover:text-indigo-600 transition">Dashboard</a>
                    ...
                    @else
                        ...
                        <a href="{{ route('register') }}" class="gradient-bg text-white px-6 py-2 rounded-full hover:shadow-lg transition">Get Started</a>
                    @endauth
                </div>
            </div>
        </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid md:grid-cols-2 gap-12 items-center">
                <div class="animate-fadeInUp">
                    <h1 class="text-5xl md:text-6xl font-bold mb-6 leading-tight">Smart WiFi Voucher Management</h1>
                    <p class="text-xl mb-8 text-indigo-100">Manage your MikroTik hotspot vouchers with ease. Create, track, and control WiFi access for your business.</p>
                    <div class="flex flex-col sm:flex-row gap-4">
                        <a href="{{ route('register') }}" class="bg-white text-indigo-600 px-8 py-4 rounded-full font-semibold hover:shadow-2xl transition text-center">Start Free Trial</a>
                        <a href="#how-it-works" class="border-2 border-white text-white px-8 py-4 rounded-full font-semibold hover:bg-white hover:text-indigo-600 transition text-center">Learn More</a>
                    </div>
    ...
    <section id="features" class="py-20 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-16">
                ...
                <p class="text-xl text-gray-600">Everything you need to manage WiFi vouchers efficiently</p>
            </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
                ...
                <div class="bg-white border-2 border-gray-200 rounded-2xl p-8 hover:shadow-xl transition">
                    ...
                    <a href="{{ route('register') }}" class="block w-full text-center bg-gray-200 text-gray-900 py-3 rounded-lg font-semibold hover:bg-gray-300 transition">Get Started</a>
                </div>

                <!-- Pro Plan -->
                <div class="bg-gradient-to-br from-indigo-600 to-purple-600 rounded-2xl p-8 text-white transform scale-105 shadow-2xl">
                    ...
                    <a href="#contact" class="block w-full text-center bg-white text-indigo-600 py-3 rounded-lg font-semibold hover:bg-gray-100 transition">Contact to Upgrade</a>
                </div>
                ...
                <div class="bg-white border-2 border-gray-200 rounded-2xl p-8 hover:shadow-xl transition">
                    ...
                    <a href="#contact" class="block w-full text-center gradient-bg text-white py-3 rounded-lg font-semibold hover:opacity-90 transition">Contact Sales</a>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-20 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid md:grid-cols-2 gap-12 items-center">
                <div>
                    <h2 class="text-4xl font-bold text-gray-900 mb-6">Manage On The Go</h2>
                    <p class="text-xl text-gray-600 mb-8">Download our mobile apps for iOS and Android to manage your vouchers anywhere, anytime.</p>
                    <div class="flex flex-col sm:flex-row gap-4">
                        <a href="#" class="flex items-center space-x-3 bg-black text-white px-6 py-3 rounded-xl hover:bg-gray-800 transition">
    ...
    <section id="contact" class="py-20 gradient-bg text-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-12">
                ...
                <p class="text-xl text-indigo-100">Have questions? We're here to help!</p>
            </div>
