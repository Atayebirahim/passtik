...
<head>
    ...
    <title>Redeem Voucher - Passtik</title>
    ...
    <div class="max-w-md w-full">
        <div class="bg-white rounded-3xl shadow-2xl p-8">
            <div class="text-center mb-8">
                ...
                <h1 class="text-3xl font-bold text-gray-900 mb-2">Redeem Voucher</h1>
                <p class="text-gray-600">Enter your voucher code to activate WiFi access</p>
            </div>
            ...
            <form id="redeemForm" class="space-y-6">
                <div>
                    ...
                    <p class="text-xs text-gray-500 mt-2">Use the same code for both username and password</p>
                </div>
            ...
            <div id="successInfo" class="hidden mt-6 p-6 bg-green-50 border-2 border-green-200 rounded-xl">
                <h3 class="text-lg font-bold text-green-900 mb-4">✓ Voucher Activated!</h3>
                ...
                <p class="mt-4 text-sm text-gray-600">Use this voucher code as both username and password to login to WiFi.</p>
            </div>
        </div>

        <p class="text-center text-sm text-gray-600 mt-6">
            Powered by <span class="font-bold">Passtik</span>
        </p>
    </div>
        ...
        form.addEventListener('submit', async (e) => {
            ...
            try {
                ...
                if (data.success) {
                    ...
                    showAlert(data.error || 'Redemption failed', 'error');
                }
            } catch (error) {
                showAlert('Network error. Please try again.', 'error');
            } finally {
                submitBtn.disabled = false;
                submitBtn.textContent = 'Activate Voucher';
            }
        });
